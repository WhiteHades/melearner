...
pub struct NativePlayerState {
    ...
    surface_render_width: Option<u32>,
    surface_render_height: Option<u32>,
    surface_render_update_flags: u64,
...
impl NativePlayer {
    ...
    fn state(&self) -> NativePlayerState {
        ...
        NativePlayerState {
            ...
            surface_render_width: surface_diagnostics.last_render_width,
            surface_render_height: surface_diagnostics.last_render_height,
            surface_render_update_flags: surface_diagnostics.last_render_update_flags,
...
fn empty_state() -> NativePlayerState {
    NativePlayerState {
        ...
        surface_render_width: None,
        surface_render_height: None,
        surface_render_update_flags: 0,
