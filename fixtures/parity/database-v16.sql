...
INSERT INTO lessons (
  id, course_id, section_id, section_name, name, path, relative_path, type,
  duration, file_size, watched_time, completed, order_index, last_position,
  updated_at
) VALUES
  (
    'lesson-video', 'course-marker', 'section-marker-intro', '01 入門', '01 welcome',
  ...
  (
    'lesson-document', 'course-marker', 'section-marker-deep', '02 Deep Storage', 'reference',
  ...
  (
    'lesson-missing-video', 'course-missing', 'section-missing-intro', '01 Intro', '01 archived',
  ...
  (
    'lesson-copy-video', 'course-copy', 'section-copy-intro', '01 Intro', '01 archived',
