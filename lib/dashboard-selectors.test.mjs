...
test("command palette prioritizes lessons for active lesson search", () => {
  assert.deepEqual(selectCommandPaletteGroupOrder("", 3), ["courses", "lessons"])
  assert.deepEqual(selectCommandPaletteGroupOrder("bitwise operations", 3), ["lessons", "courses"])
  assert.deepEqual(selectCommandPaletteGroupOrder("bitwise operations", 0), ["courses", "lessons"])
})
