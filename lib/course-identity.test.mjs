...
test("selectCourseIdentityMatch prefers one unambiguous marker identity", () => {
  const result = selectCourseIdentityMatch(
    { ...scannedCourse, markerIdentityId: "identity-1", fingerprint: "changed-fingerprint" },
    undefined,
    [persistedCourse],
    [],
    new Set()
...
test("selectCourseIdentityMatch refuses a claimed marker identity", () => {
  const claimed = new Set(["persisted-course"])
  const result = selectCourseIdentityMatch(
    { ...scannedCourse, markerIdentityId: "identity-1" },
    undefined,
    [persistedCourse],
    [],
    claimed
