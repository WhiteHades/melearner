...
Accepted for local SQLite ownership. ADR 0012 supersedes the browser-storage, frontend write-queue, `tauri-plugin-sql`, Tauri transport, and Rust ownership details for the final architecture; they remain historical or transitional constraints until cutover.
